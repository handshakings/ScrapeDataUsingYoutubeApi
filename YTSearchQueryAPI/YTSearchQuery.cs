...
namespace YTSearchQueryApiLib
{
    ...
    {
        public async Task<List<string>> GetYTDataUI(UserInput userInput)
        {
            string[] apiKeys = File.ReadAllText(userInput.ApiKeysFile).Split('\n');
            var youtubeService = new YouTubeService(new BaseClientService.Initializer()
            {
                ApiKey = (userInput. apiKey.Length > 30) ? apiKey : "AIzaSyC5lmdB4ynaUVE8xoXI5I-dL0WhW7rhY3Q",
